...
func (w *Watcher) flush() {
	...
	// TODO(tgross): this was copied over from deploymentwatcher, but
	// shouldn't this use the server's shutdown context and not
	// Background?
...
func (w *Watcher) forceAdd(volID, namespace string) (*volumeWatcher, error) {
	...
	vol, err := snap.CSIVolumeByID(ws, volID, namespace)
	if err != nil {
		return nil, err
	}
	if vol == nil {
